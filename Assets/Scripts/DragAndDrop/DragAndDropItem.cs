...
public class DragAndDropItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	...
	public void OnBeginDrag(PointerEventData eventData)
	{
		if (dragDisabled == false)
		{
			...
			iconImage.sprite = myImage.GetComponent<PorteScript>().spriteOff;
            ...
            this.GetComponent<PorteScript>().SetSortie(false);
            this.GetComponent<PorteScript>().SetEntree1(false);
            this.GetComponent<PorteScript>().SetEntree2(false);
